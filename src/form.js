  ...
  function formLoader(parentNode) {
    ...
    const titleInput = inputMaker('text', 'form-control', 'title-input', 'Enter Title');
    ...
    const descriptionInput = inputMaker('text', 'form-control', 'description-input', 'Enter Description');
    ...
    const prioritySelect = mySelectMaker('form-control', ["Low", "Medium", "High"]);
